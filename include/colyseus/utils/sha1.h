// From: https://github.com/vog/sha1/blob/3f8a4aa032d144309d00dbfe972906a49b3631b9/sha1.hpp
/*
...
inline static void
R0(const uint32_t block[BLOCK_INTS],
   const uint32_t v,
   uint32_t& w,
   const uint32_t x,
   const uint32_t y,
...
std::array<char, 20> SHA1::final() {
  ...
  // Snippet bellow is from websocketpp
  // Store hash in result array pointer, and make sure we get in in the correct
